...
export const CAL_URL_SHORT = "google-calendar/axda-studio" as const
export const GITHUB_URL = "https://github.com/axda-studio" as const
export const GITHUB_URL_SHORT = "github/axda-studio" as const
export const LINKEDIN_URL = "https://www.linkedin.com/in/alyx-darenne" as const
export const LINKEDIN_URL_SHORT = "linkedin/alyx-darenne" as const
